      ...
      <Card sx={{ mb: 3 }}>
        <CardContent>
          ...
          <Box sx={{ 
            ...
            <Typography variant="h2" sx={{ fontSize: 48, color: '#1565c0', mb: 2 }}>
              📁
            </Typography>
          ...
          {message && (
            <Alert 
              ...
              sx={{ mt: 2 }}
              icon={message.includes('Complete') ? "📊" : undefined}
            >
              {message}
            </Alert>
          )}
        ...
        <CardContent>
          ...
          <Box sx={{ bgcolor: 'rgba(25, 118, 210, 0.05)', p: 2, borderRadius: 1 }}>
            <Typography variant="body2" sx={{ display: 'flex', alignItems: 'center' }}>
              <span style={{ marginRight: 8, color: '#1565c0', fontSize: '1.2em' }}>🔒</span>
